...
@Component({
  selector: 'app-slide-curso-adolescentes',
  templateUrl: './slide-curso-adolescentes.component.html',
  styleUrls: ['./slide-curso-adolescentes.component.css']
})

export class SlideCursoAdolescentesComponent {
  ...
  onImageClick(videoUrl: string, title: string): void {
    ...
    this.router.navigate(['/video-player'], {
      queryParams: {
        videoUrl,
        title,
        returnTo: currentUrl // mais limpo
      }
    });
  }
