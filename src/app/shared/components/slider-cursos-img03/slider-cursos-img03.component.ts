...
@Component({
  selector: 'app-slider-cursos-img03',
  templateUrl: './slider-cursos-img03.component.html',
  styleUrls: ['./slider-cursos-img03.component.css']
})
export class SliderCursosImg03Component {
  images = [
    'assets/nt01.jpg',
    'assets/nt02.jpg',
    'assets/nt03.jpg',
