...
@Component({
  selector: 'app-slider-cursos-img02',
  templateUrl: './slider-cursos-img02.component.html',
  styleUrls: ['./slider-cursos-img02.component.css']
})
export class SliderCursosImg02Component {
  images = [
    'assets/nt01.jpg',
    'assets/nt02.jpg',
    'assets/nt03.jpg',
