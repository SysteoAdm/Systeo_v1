...
@Component({
  selector: 'app-slider-cursos-img01', // Define o seletor do componente
  templateUrl: './slider-cursos-img01.component.html', // Define o arquivo HTML do componente
  styleUrls: ['./slider-cursos-img01.component.css'] // Define o arquivo de estilos CSS do componente
})
export class SliderCursosImg01Component {
  ...
  images = [
    ...
    { img: 'assets/mini_cover9.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 9 - ' },
    { img: 'assets/mini_cover1.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 1 - Qual é o Seu Propósito?' },
    { img: 'assets/mini_cover2.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 2' },
    { img: 'assets/mini_cover3.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 3' },
    { img: 'assets/mini_cover4.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 2' },
    { img: 'assets/mini_cover5.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 3' },
    { img: 'assets/mini_cover6.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 2' },
    { img: 'assets/mini_cover7.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 3' },
    { img: 'assets/mini_cover8.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 2' },
    { img: 'assets/mini_cover9.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 3' },
