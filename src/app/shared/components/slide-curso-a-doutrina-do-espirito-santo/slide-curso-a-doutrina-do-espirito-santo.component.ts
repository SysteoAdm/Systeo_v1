...
@Component({
  selector: 'app-slide-curso-a-doutrina-do-espirito-santo',
  templateUrl: './slide-curso-a-doutrina-do-espirito-santo.component.html',
  styleUrls: ['./slide-curso-a-doutrina-do-espirito-santo.component.css']
})

export class SlideCursoADoutrinaDoEspiritoSantoComponent {
   ...
   images = [
     { img: 'assets/mini_cover1.webp', videoUrl: 'https://www.youtube.com/embed/umjSQ7IuYhM', title: 'Aula 1 - Qual é o 10500 Seu Propósito | Pr. Wander Gomes?' },
